...
const contract_address = "0x316d3454106d595E5ee59d2099B5048E8AedaB6f"
...
async function main() {
    ...
    //await hp.fund({ value: ethers.utils.parseEther("100") })
    //const rewards_balance = await hp.get_balance()
    //console.log(rewards_balance / 1000000000000000000)
    //await hp.add_admin(admin_address)
    //await hp.transferToAmbassadors(ambassador_address)
    await hp.withdraw()
